...
def main(args):
  train_data = pickle.load(open("../../german_small_updated/german_train2_token.pkl", "rb"))
  val_data = pickle.load(open("../../german_small_updated/german_val2_token.pkl", "rb"))
  test_data = pickle.load(open("../../german_small_updated/german_test2_token.pkl", "rb"))
  #BI_test_gt = pickle.load(open("../../german_small_updated/german_test2_tag.pkl", "rb"))
  BI_val_gt = pickle.load(open("../../german_small_updated/german_val2_tag.pkl", "rb"))
